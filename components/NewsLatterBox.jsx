const NewsLatterBox = () => {
    return (
      ...
      >
        ...
        <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base font-tektur leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
        ...
        <form>
          <input
            ...
            className="mb-4 w-full rounded-md border border-body-color border-opacity-10 py-3 px-6 text-base font-tektur text-body-color placeholder-body-color outline-none focus:border-primary focus:border-opacity-100 focus-visible:shadow-none dark:border-white dark:border-opacity-10 dark:bg-[#242B51] focus:dark:border-opacity-50"
          />
          <input
            type="email"
            name="email"
          ...
          <input
            type="submit"
            value="Subscribe"
            className="duration-80 mb-4 w-full cursor-pointer rounded-md border border-transparent bg-primary py-3 px-6 text-center text-base font-tektur text-white outline-none transition ease-in-out hover:bg-opacity-80 hover:shadow-signUp focus-visible:shadow-none"
          />
          <p className="text-center text-base font-tektur leading-relaxed text-body-color">
